using ExemploCasoContratacaoProdutoRamoFinanceiro.Application.Common.Exceptions;
using FluentAssertions;
using FluentValidation.Results;
using NUnit.Framework;

namespace ExemploCasoContratacaoProdutoRamoFinanceiro.Application.UnitTests.Common.Exceptions;
